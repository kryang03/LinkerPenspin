...
#
# 示例:
#   bash optuna/run_hpo.sh 0 30 300000000
...
python optuna/tune_teacher.py \
    ...
    --n_trials "$N_TRIALS" \
    --max_steps "$MAX_STEPS" \
    --storage "sqlite:///optuna/hpo_teacher.db" \
    --study_name "teacher_ppo_hpo" \
    --load_if_exists
...
echo "  2. 最佳参数: optuna/best_params_teacher_ppo_hpo.txt"
echo "  3. 可视化图表: optuna/param_importances_teacher_ppo_hpo.html"
echo "  4. 优化历史: optuna/optimization_history_teacher_ppo_hpo.html"
