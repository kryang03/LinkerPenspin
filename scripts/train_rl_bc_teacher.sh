#!/bin/bash
# ========================================
# 功能2: RL+BC训练Teacher模型
# 使用全部信息（包括特权信息），结合已训练Teacher模型的回放
# ========================================
# chmod +x scripts/train_rl_bc_teacher.sh
# nohup scripts/train_rl_bc_teacher.sh 0 42 teacher_rl_bc_test outputs/LinkerHandHora/teacher_rl_test/teacher_nn/best_reward_xxx.pth > teacher_rl_bc_test.txt &
